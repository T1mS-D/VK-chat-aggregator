...
## Настройка VK
В панели управления сообществом:
- Сообщения -> Включить
- Дополнительно -> Работа с API -> Ключи доступа -> Сгенерировать ваш VK_GROUP_TOKEN
- Дополнительно -> Работа с API -> Long Poll API -> Включить (версия 5.131)
- Long Poll API -> Типы событий: Записи на стене, Комментарии на стене
